...
use Masterdom\Application\Adapter\DesignProject\DesignInterior;
use Masterdom\Application\Adapter\User;
use Masterdom\Domain\Model\DesignProject\DesignProject as DomainDesignProject;
...
class DesignProject
{
     ...
     * @var User
     * @Type("Masterdom\Application\Adapter\User")
     * @Expose
     */
    private $owner;
    /**
     ...
     * @var DesignInterior[]
     * @Type("array<Masterdom\Application\Adapter\DesignProject\DesignInterior>")
     * @Expose
     */
    private $interiors;
