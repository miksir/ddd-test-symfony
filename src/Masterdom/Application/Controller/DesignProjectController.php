...
namespace Masterdom\Application\Controller;

use Masterdom\Application\DTO\DesignProject\DesignPhotoResponse;
use Masterdom\Application\DTO\DesignProject\DesignPhotoUploadRequest;
use Masterdom\Application\DTO\DesignProject\DesignProjectRequest;
use Masterdom\Application\DTO\DesignProject\DesignProjectResponse;
use Masterdom\Application\DTO\DesignProject\DesignProjectsResponse;
use Masterdom\Application\DTO\ErrorResponse;
...
use Masterdom\Domain\Service\DesignPhoto\DesignPhotoAddException;
...
use Masterdom\Domain\Service\User\UserFindException;
...
class DesignProjectController extends RestController
{
     ...
     *     responseMap = {
     *         200 = {
     *              "class" = "Masterdom\Application\DTO\DesignProject\DesignProjectResponse",
     *              "groups" = { "Default" },
     *         },
     *         400 = {
     *              "class" = "Masterdom\Application\DTO\ErrorResponse",
     ...
     *     },
     *     input = {
     *          "class" = "Masterdom\Application\DTO\DesignProject\DesignProjectRequest",
     *          "groups" = { "Default", "post" },
     *     }
     * )
     ...
     * @ParamConverter("project", class="Masterdom\Application\DTO\DesignProject\DesignProjectRequest", converter="fos_rest.request_body")
     */
     ...
     *     responseMap = {
     *         200 = {
     *              "class" = "Masterdom\Application\DTO\DesignProject\DesignProjectsResponse",
     *              "groups" = { "Default" },
     *         },
     *         400 = {
     *              "class" = "Masterdom\Application\DTO\ErrorResponse",
     ...
     *     responseMap = {
     *         200 = {
     *              "class" = "Masterdom\Application\DTO\DesignProject\DesignPhotoResponse",
     *              "groups" = { "Default" },
     *         },
     *         400 = {
     *              "class" = "Masterdom\Application\DTO\ErrorResponse",
