...
use Masterdom\Application\Adapter\User;
use Masterdom\Application\DTO\{
...
use Masterdom\Domain\Service\User\UserRegistrationException;
...
class UserController extends RestController
{
     ...
     *     responseMap = {
     *         200 = {
     *              "class" = "Masterdom\Application\DTO\UserResponse",
     ...
     *     },
     *     input = {
     *          "class" = "Masterdom\Application\DTO\UserIdentityRequest",
     *     }
     * )
     *
     ...
     * @ParamConverter("identity", class="Masterdom\Application\DTO\UserIdentityRequest", converter="fos_rest.request_body")
     */
     ...
     *     },
     *     input = {
     *          "class" = "Masterdom\Application\DTO\UserCreateRequest",
     *          "groups" = { "Default", "post" },
     *     }
     * )
     *
     ...
     * @param ConstraintViolationListInterface $validationErrors
     * @return \Symfony\Component\HttpFoundation\Response
     * @ParamConverter("user", class="Masterdom\Application\DTO\UserCreateRequest", converter="fos_rest.request_body")
     */
     ...
     *     },
     *     input = {
     *          "class" = "Masterdom\Application\DTO\UserUpdateRequest",
     *          "groups" = { "Default", "put" },
     *     }
     * )
     *
     ...
     * @param ConstraintViolationListInterface $validationErrors
     * @return \Symfony\Component\HttpFoundation\Response
     * @ParamConverter("user", class="Masterdom\Application\DTO\UserUpdateRequest", converter="fos_rest.request_body")
     */
