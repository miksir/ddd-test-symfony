...
use Masterdom\Application\DTO\DesignProject\DesignInteriorRequest;
use Masterdom\Domain\Adapter\ArrayCollection;
use Masterdom\Domain\Service\DesignProject\DesignProjectCreateInteriorRequest;
use Masterdom\Domain\Service\DesignProject\DesignProjectCreateRequest;
...
class DesignProjectRequest implements DesignProjectCreateRequest
{
     ...
     * @Type("array<Masterdom\Application\DTO\DesignProject\DesignInteriorRequest>")
     * @Assert\NotNull()
